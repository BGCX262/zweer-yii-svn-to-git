...
class IssueController extends Controller
{
    ...
    /**
     * @var Project private property containing the associated Project model instance.
     */
	...
	public function filters()
	{
		return array(
            ...
            'projectContext + create index admin' // check to ensure valid context project
		);
	}
     ...
     *
	 * @param $id int The ID of the model to be loaded
     * @throws CHttpException If the ID does not correspond to any project
     * @return Project The project identified by the ID
	 */
